...
Dar nu fi depresiv tinere ~~idiot~~ programator, poti sa-ti speli pacatele cu apa sfintita a lui Arsenie Boca la doar 99.95 de lei si prin parametrizarea(dai ca argument) variabilei diferite, crearea unei functii noi si eradicare pe rug a functiilor pacatoase.
```cpp
